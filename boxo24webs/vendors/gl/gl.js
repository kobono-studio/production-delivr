import { Vec4, Renderer, Program, Mesh, Camera, Transform, Texture, Plane } from 'ogl'

import { displacement } from './displacement-19'
...
class GL {
  ...
  setProgress(fromIndex, toIndex, progress, needsTransitionDuration, needShaderReplace) {
    ...
    if (this.swiper.params.loop && this.swiper.slides[fromIndex] && this.swiper.slides[toIndex]) {
      fromIndex = parseInt(
